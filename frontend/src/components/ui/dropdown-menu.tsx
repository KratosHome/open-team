...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        'group/dropdown-menu-item relative flex cursor-pointer items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm font-medium transition-all duration-200 outline-none select-none',
        'text-white hover:bg-[#2A2A44] focus:bg-[#2F2F4A]',
