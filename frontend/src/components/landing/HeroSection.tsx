    ...
    <div className="pt-24 pb-20">
      <main className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div className="flex flex-col gap-10">
          <div className="hero-badge animate-hero-up inline-flex w-fit items-center gap-3 rounded-2xl border border-white/5 bg-[#1e2230]/50 px-4 py-2 text-xs font-medium text-white/60 backdrop-blur-sm">
          ...
          <h1 className="hero-title font-sans text-6xl leading-[1] font-bold tracking-tight md:text-8xl">
            {dict.heroTitle}
            <br />
